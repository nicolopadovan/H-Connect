...
extension UIView {
    ...
    @discardableResult
    public func constrainHeight(_ constraint: NSLayoutAnchor<NSLayoutDimension>) -> AnchoredConstraints {
        translatesAutoresizingMaskIntoConstraints = false
        var anchoredConstraints = AnchoredConstraints()
        anchoredConstraints.height = heightAnchor.constraint(equalTo: constraint)
        anchoredConstraints.height?.isActive = true
        return anchoredConstraints
    }
    ...
    @discardableResult
    public func constrainWidth(_ constraint: NSLayoutAnchor<NSLayoutDimension>) -> AnchoredConstraints {
        translatesAutoresizingMaskIntoConstraints = false
        var anchoredConstraints = AnchoredConstraints()
        anchoredConstraints.width = widthAnchor.constraint(equalTo: constraint)
        anchoredConstraints.width?.isActive = true
        return anchoredConstraints
    }
